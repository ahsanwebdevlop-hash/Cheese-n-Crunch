...
import OtherCategoriesSection from '../components/OtherCategoriesSection.jsx';
import GallerySection from '../components/GallerySection.jsx';
import { GALLERY, OTHER_CATEGORIES, SPECIAL_FLAVORS, REGULAR_FLAVORS } from '../data/siteData.js';
...
function Menu({ specialFlavors, regularFlavors, onFlavorClick, onAdd, onShowToast, onImageClick }) {
  ...
  return (
    <>
      ...
      <OtherCategoriesSection categories={OTHER_CATEGORIES} />
