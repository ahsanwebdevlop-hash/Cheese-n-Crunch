...
export const MENU_BY_CATEGORY = [
  ...
  },
  {
    ...
    title: 'Wraps',
    items: [
      { name: 'Cocktail Wrap', description: 'Crispy chicken with tangy cocktail sauce wrap.', varient: [{ size: 'Small', price: 400 },{ size: 'Large', price: 600 }], img: 'https://example.com' },
      { name: 'Chatkhara Wrap', description: 'Spicy chicken with traditional tangy chatkhara spices.', price: 495, img: 'https://example.com' },
      { name: 'Hari Bhari Wrap', description: 'Fresh green herb marinated chicken wrapped tightly.', price: 495, img: 'https://example.com' },
      { name: 'Malai Boti Wrap', description: 'Creamy barbecue chicken malai boti wrapped smoothly.', price: 495, img: 'https://example.com' },
      { name: 'Turkish Wrap', description: 'Authentic Turkish style grilled chicken wrap.', price: 495, img: 'https://example.com' },
...
export const DEALS = [
  { n: 1, title: 'Deal 1', items: '1 Small Pizza, 6 Oven Baked Wings, 1 Reg. Drink', price: 945, img: 'https://images.unsplash.com/photo-1513104890138-7c749659a591?q=80&w=800&auto=format&fit=crop' },
  { n: 2, title: 'Deal 2', items: '1 Wrap, 1 Panini Tikka Sandwich, Half Liter Drink', price: 1055, img: 'https://images.unsplash.com/photo-1509722747041-616f39b57569?q=80&w=800&auto=format&fit=crop' },
  { n: 3, title: 'Deal 3', items: '12 Wings Patty Burger, Chappli Burger, Half Liter Drink', price: 1475, img: 'https://images.unsplash.com/photo-1548365328-9f547fb0953b?q=80&w=800&auto=format&fit=crop' },
  { n: 4, title: 'Deal 4', items: '1 Reg. Pizza, 1 Supreme Sandwich, Half Liter Drink', price: 1845, img: 'https://images.unsplash.com/photo-1568901346375-23c9450c58cd?q=80&w=800&auto=format&fit=crop' },
  { n: 5, title: 'Deal 5', items: '1 Large Pizza, 1 Brownie, 1 Liter Drink', price: 1895, img: 'https://images.unsplash.com/photo-1621996346565-e3dbc646d9a9?q=80&w=800&auto=format&fit=crop' },
  { n: 6, title: 'Deal 6', items: '4 Zinger Burger, 1 Liter Drink', price: 1945, img: 'https://images.unsplash.com/photo-1590947132387-155cc02f3212?q=80&w=800&auto=format&fit=crop' },
  { n: 7, title: 'Deal 7', items: '1 Grand Square, CnC Pasta, 1.5 Liter Drink', price: 2695, img: 'https://images.unsplash.com/photo-1600628421066-f6bda6a7b976?q=80&w=800&auto=format&fit=crop' },
  { n: 8, title: 'Deal 8', items: '1 XL Pizza, CnC burger, 1.5 Liter Drink', price: 2795, img: 'https://images.unsplash.com/photo-1571091718767-18b5b1457add?q=80&w=800&auto=format&fit=crop' },
  { n: 9, title: 'Deal 9', items: '2 Large Pizza, 1.5 Liter Drink', price: 3295, img: 'https://images.unsplash.com/photo-1567620832903-9fc6debc209f?q=80&w=800&auto=format&fit=crop' },
  { n: 10, title: 'Deal 10', items: '2 XL Pizza, 2 Drinks 1 Liter', price: 4495, img: 'https://images.unsplash.com/photo-1626082927389-6cd097cee6a6?q=80&w=800&auto=format&fit=crop' },
];
